...
vulnerable_vsftpd_config:
  file.managed:
    ...
    - contents: |
        ...
        #
        # max_clients and max_per_ip are used for connection limits. Setting values
        # to 0 ensures that the default connections limit of 2 per IP is enabled.
        max_clients=0
        max_per_ip=0
